...
<body style="background: url('photo/loginpage.jpg'); background-size: 100%">
	<div class="login-box">
  <div class="well well-sm center" style="width: 25%;margin: auto;padding:4px 11px;margin-top: 170px;text-align: center;">
  	<h3 class="center" style="margin-top:15px">Log In</h3>
  </div>
  <!-- /.login-logo -->
...
if (isset($_POST['login'])) 
{
	$user = $_POST['email'];
    $pass = $_POST['password'];
    $con = new mysqli('localhost','root','Shubhra@04','store');
